--- STEAMODDED HEADER
--- MOD_NAME: Traducció al català
--- MOD_ID: catalan_translation
--- MOD_AUTHOR: [JocsEnCat]
--- MOD_DESCRIPTION: Una traducció al català de Balatro
...
function SMODS.INIT.Better_FR()
    ...
    local mod = SMODS.findModByID("catalan_translation")
    local lang_path = mod.path.."ca.lua"
    ...
    if love.filesystem.exists(lang_path) and G.LANG.key == "en-US" then
        apply_patch()
    end
