...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.LANGUAGES = {
            ...
            ['ca'] = {font = 1, label = "Català", key = 'ca', omit = false, beta = nil, button = "Comentaris de Traducció", warning = {'This language is still in Beta. To help us','improve it, please click on the feedback button.', 'Click again to confirm'}},
